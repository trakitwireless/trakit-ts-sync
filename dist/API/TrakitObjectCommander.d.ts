...
export declare abstract class TrakitObjectCommander<TRequest> extends TrakitBaseCommander<TRequest> {
     ...
     */
    recoverStart(username: email, key?: string | nothing, query?: string | nothing): Promise<RepSelfRecoverStart>;
    /**
     ...
     */
    recoverComplete(guid: guid, length?: uint | nothing): Promise<RepSelfRecoverComplete>;
    /**
