import { IRepList, PaySubscriptionDelete, PaySubscriptionMerge, Reply, RepSelfGet, RepSubscription, SubscriptionType } from "@trakit/commands";
import {
	Base,
	BaseComponent,
...
import { CMD_DISCONNECTION, TrakitSocketCommander } from "../commands/TrakitSocketCommander";
import { TrakitSocketStatus } from "../commands/TrakitSocketStatus";
import { SubscribedRegions } from "../worker/SubscribedRegions";
import { JSON_PARSE_SAFE } from "./JSON";
import { SUBSCRIPTION_LIST_BY_COMPANY, SUBSCRIPTION_SPLITS } from "./Subscriptions";
import { SyncInit } from "./SyncInit";
import { SyncMessage } from "./SyncMessage";
import { SyncRestful } from "./SyncRestful";
...
export class TrakitSync {
	 ...
	 **/
	#subscribe(company: ulong, regions: SubscriptionType[]) {
	 ...
	 * Sends a (un)subscribe command to the Trak-iT WebSocket for the given company and regions.
	 **/
	#unsubscribe(company: ulong, regions: SubscriptionType[]) {
